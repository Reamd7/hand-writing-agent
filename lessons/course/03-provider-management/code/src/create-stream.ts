...
import type {
  ...
  LanguageModelV2Middleware as LanguageModelMiddleware,
} from "@ai-sdk/provider";
import type { ModelRegistry } from "./model-registry.js";
import { createLoggingMiddleware } from "./middleware.js";

// ---------------------------------------------------------------------------
// Message types (simplified from pi's types.ts)
// ---------------------------------------------------------------------------
...
export interface ThinkingContent {
  type: "thinking";
  thinking: string;
  /** Provider-specific signature for replay */
  thinkingSignature?: string;
  /** Encrypted/opaque content only valid for the originating model */
  redacted?: boolean;
}
 ...
 */
export function createStream(registry: ModelRegistry, options: CreateStreamOptions) {
  const {
    modelKey,
    messages,
    system,
