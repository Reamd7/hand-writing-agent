...
async function main() {
  ...
  for await (const part of result.fullStream) {
    switch (part.type) {
      ...
      case "tool-call":
        console.log(
          `[tool-call] Tool: ${part.toolName}, ID: ${part.toolCallId}, Args: ${JSON.stringify(part.input)}`,
        );
        break;
      ...
      case "tool-result":
        console.log(`[tool-result] Tool: ${part.toolName}, Result: ${JSON.stringify(part.output)}`);
        break;
