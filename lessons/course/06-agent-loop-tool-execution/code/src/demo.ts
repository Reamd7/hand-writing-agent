...
import type { AgentContext, AgentLoopConfig, AgentTool, AssistantMessage } from "./types.js";
...
async function scenario1() {
  ...
  await agentLoop("What's the weather in Tokyo?", createContext(), config);
}
...
async function scenario2() {
  ...
  await agentLoop("Compare weather in London and Paris", createContext(), config);
}
...
async function scenario3() {
  ...
  await agentLoop("Delete /etc/passwd", createContext(), config);
}
...
async function scenario4() {
  ...
  await agentLoop("Search for TypeScript generics", createContext(), config);
}
...
async function scenario5() {
  ...
  await agentLoop("Build the project for release", createContext(), config);
}
...
async function scenario6() {
  ...
  await agentLoop("What is the answer?", createContext(), config);
}
...
async function scenario7() {
  ...
  await agentLoop("Save Alice to users and check Berlin weather", createContext(), config);
}
