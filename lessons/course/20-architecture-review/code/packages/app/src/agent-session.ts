...
// ---------------------------------------------------------------------------
// Types from @my-agent/core
// ---------------------------------------------------------------------------

import type { ThinkingLevel } from "@my-agent/core";
export type { ThinkingLevel };

// ---------------------------------------------------------------------------
// Lesson-specific simplified types
// (Deliberately simplified for the CLI-layer simulation in this lesson.
//  A real agent session would use the full types from pi-ai / pi-agent-core.)
// ---------------------------------------------------------------------------
