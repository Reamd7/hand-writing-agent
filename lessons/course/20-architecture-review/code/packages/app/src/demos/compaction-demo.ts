...
function buildSimulatedConversation(): ModelMessage[] {
    ...
    content: [
      {
        ...
        toolCallId: "tc1",
        toolName: "write",
        output: { type: "text", value: "File written: package.json" },
      },
    ],
  });
    ...
    content: [
      {
        ...
        toolCallId: "tc2",
        toolName: "write",
        output: { type: "text", value: "File written: src/App.tsx" },
      },
    ],
  });
    ...
    content: [
      {
        ...
        toolCallId: "tc3",
        toolName: "write",
        output: { type: "text", value: "File written: src/components/TaskList.tsx" },
      },
    ],
  });
  ...
  messages.push({
    ...
    content: [
      ...
      },
      {
        ...
        toolCallId: "tc4",
        toolName: "read",
        input: { path: "src/components/TaskList.tsx" },
      },
    ],
  });
    ...
    content: [
      {
        ...
        toolCallId: "tc5",
        toolName: "write",
        output: { type: "text", value: "File written: src/context/TaskContext.tsx" },
      },
    ],
  });
    ...
    content: [
      {
        ...
        toolCallId: "tc6",
        toolName: "write",
        output: { type: "text", value: "File written: src/components/TaskItem.tsx" },
      },
    ],
  });
    ...
    content: [
      {
        ...
        toolCallId: "tc7",
        toolName: "write",
        output: { type: "text", value: "File written: src/styles/TaskItem.module.css" },
      },
    ],
  });
