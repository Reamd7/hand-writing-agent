...
// ---------------------------------------------------------------------------
// Lesson 13: Session Persistence
// ---------------------------------------------------------------------------
export { SessionManager, buildSessionContext, loadEntriesFromFile } from "./session-manager.js";
export type {
  SessionEntryType,
  SessionEntryBase,
  SessionMessageEntry,
...
// ---------------------------------------------------------------------------
// Lesson 15: Extension API
// ---------------------------------------------------------------------------
export { ExtensionRunner } from "./extension-runner.js";
export type { ExtensionActions, ContextActions } from "./extension-runner.js";
export {
...
// ---------------------------------------------------------------------------
// Lesson 19: Production Hardening
// ---------------------------------------------------------------------------
export {
  getDefaultConfig,
  validateConfig,
...
export type {
  RetryConfig as AppRetryConfig,
  CompactionConfig as AppCompactionConfig,
