...
// ink requires a real TTY with raw mode support for interactive input.
// When running in a non-TTY environment (CI, piped stdin, etc.), exit gracefully.
if (!process.stdin.isTTY) {
  console.log("TUI requires an interactive terminal (TTY) with raw mode support.");
  console.log("Run this in a real terminal: pnpm --filter @my-agent/app tui");
  process.exit(0);
}
