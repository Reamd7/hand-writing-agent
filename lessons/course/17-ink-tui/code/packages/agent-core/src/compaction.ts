 ...
 */
function extractFileOperations(messages: ModelMessage[]): FileOperations {
        ...
        if (typeof msg.content === "string") {
          ...
          for (const part of msg.content) {
            ...
            if (part.type === "tool-call") {
              const argsStr = JSON.stringify((part as any).input);
        ...
        if (Array.isArray(msg.content)) {
          for (const part of msg.content) {
            if (part.type === "tool-result") {
              ...
              const text =
                typeof partOutput === "string" ? partOutput : JSON.stringify(partOutput);
 ...
 */
export function rebuildMessages(summary: string, keptMessages: ModelMessage[]): ModelMessage[] {
  return [
    {
      role: "user" as const,
