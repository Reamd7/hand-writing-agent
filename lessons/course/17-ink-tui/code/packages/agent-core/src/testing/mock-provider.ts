...
// ---------------------------------------------------------------------------
// Foundational types (from @earendil-works/pi-ai)
// ---------------------------------------------------------------------------
...
export type ToolCall = PiToolCall;
export type AssistantContentBlock = TextContent | ToolCall;
export type StopReason = PiStopReason;
export type Usage = PiUsage;
export type AssistantMessage = PiAssistantMessage;

// Lesson-specific simplified message types (mock provider uses simpler shapes)
